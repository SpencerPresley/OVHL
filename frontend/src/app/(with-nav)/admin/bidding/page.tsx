      ...
      <Card className="mb-8">
        ...
        <CardContent>
          ...
          <div className="card-gradient rounded-lg p-4 mb-6">
            ...
            <p className="mb-4">
              This will finalize any bids that have expired (showing as "Ending...") but haven't
              been processed:
            </p>

            <Button onClick={fixExpiredBids} disabled={isFixingExpired} className="mt-2">
          ...
          <div className="card-gradient rounded-lg p-4 mb-6">
            ...
            <p className="mb-4">
              This will fix players stuck in bidding in the database, especially those already on
              teams:
            </p>
          ...
          <div className="mt-8">
            ...
            <Card className="bg-red-950/30 border-red-800/50">
              <CardHeader>
                ...
                <CardDescription>
                  This will completely delete all bidding data in Redis and the database. This
              ...
              <CardContent>
                <div className="space-y-4 mb-4">
                  ...
                  <p className="text-xs text-gray-400 mt-1 ml-6">
                    If checked, all database bid records will be deleted and player bidding flags
                    will be reset.
                  </p>
          ...
          <Card className="mb-4">
            ...
            <CardContent>
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="flex flex-col space-y-4">{/* ... existing code ... */}</div>
                ...
                <div className="flex flex-col space-y-4 mt-4">
                  ...
                  <div className="flex flex-row flex-wrap gap-2">
                    <Button
                      ...
                      disabled={
                        isActionPending || Boolean(biddingStatuses[selectedLeagueId]?.active)
                      }
