          ...
          <div className="mb-2">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span
                className={cn(
                  'font-mono',
                  team.salary.cap - team.salary.current > 0 ? 'text-green-400' : 'text-red-400'
                )}
              >
          ...
          <div className="w-full h-2 bg-gray-800 rounded-full overflow-hidden mb-3">
            <div
              className={cn('h-full', {
                ...
                'bg-yellow-500':
                  team.salary.current / team.salary.cap >= 0.8 &&
                  team.salary.current / team.salary.cap < 1,
        ...
        <div>
          ...
          <div className="mt-4 space-y-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <span
                className={cn('font-mono', availableCap > 0 ? 'text-blue-400' : 'text-red-400')}
              >
          ...
          <div className="w-full h-4 bg-gray-700 rounded-full overflow-hidden mt-4">
            <div className="flex h-full">
              ...
              <div
                ...
                style={{
                  width: `${Math.min(100 - (currentSpent / salaryCap) * 100, (committed / salaryCap) * 100)}%`,
                }}
              ></div>
              <div
          ...
          {availableCap < 8500000 && (
            <div className="mt-4 p-3 bg-red-500/20 border border-red-500/40 rounded-md">
              ...
              <p className="text-xs text-gray-300 mt-1">Total minimum roster cost: $8.5M</p>
            </div>
          )}
        </div>
      </div>
