...
class GamertagHistoryActions(Generic[_PrismaModelT]):
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second GamertagHistory record ordered by the playerId field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group GamertagHistory records by playerId values
        # and count how many records are in each group
            ...
            data=[
                {
                    # data to create a Tier record
                    'seasonId': 'jdcfdcgc',
                    'leagueLevel': 2053047983,
                    'name': 'gifdddbia',
                },
                {
                    # data to create a Tier record
                    'seasonId': 'bchehecef',
                    'leagueLevel': 948921754,
                    'name': 'bjgejjabff',
                },
            ],
            skip_duplicates=True,
    ...
    async def create(
        ...
        team = await Team.prisma().create(
            data={
                ...
                'eaClubId': 'ihcahiead',
                'eaClubName': 'biheheiajg',
                'officialName': 'jbgijghgb',
                'teamIdentifier': 'hgjcghfbi',
            },
        )
        ```
        """
            ...
            data=[
                {
                    ...
                    'eaClubId': 'icadbcehj',
                    'eaClubName': 'jchciaee',
                    'officialName': 'deeificjd',
                    'teamIdentifier': 'bbcbhebbda',
                },
                {
                    # data to create a Team record
                    'eaClubId': 'bejfijgcfb',
                    'eaClubName': 'caifcbgii',
                    'officialName': 'igaibbfgj',
                    'teamIdentifier': 'bggajdcbbi',
                },
            ],
            skip_duplicates=True,
        )
        ...
        *,
        ...
        total = await PlayerTierHistory.prisma().create_many(
            data=[
                {
                    # data to create a PlayerTierHistory record
                    'playerSeasonId': 'fbahdheji',
                    'tierId': 'cbbheiicgh',
                },
                {
                    # data to create a PlayerTierHistory record
                    'playerSeasonId': 'beabjeejdg',
                    'tierId': 'bcjhgahffd',
                },
            ],
            skip_duplicates=True,
    ...
    async def create(
        ...
        playerteamseason = await PlayerTeamSeason.prisma().create(
            data={
                ...
                'playerSeasonId': 'cacjdfhejh',
                'teamSeasonId': 'bdbifjhbbi',
            },
        )
        ```
        """
        ...
        *,
        ...
        total = await PlayerTeamSeason.prisma().create_many(
            data=[
                {
                    # data to create a PlayerTeamSeason record
                    'playerSeasonId': 'cbccbbcdfb',
                    'teamSeasonId': 'bacejedaca',
                },
                {
                    # data to create a PlayerTeamSeason record
                    'playerSeasonId': 'bhbhdahfaj',
                    'teamSeasonId': 'bfjibceaec',
                },
            ],
            skip_duplicates=True,
        )
    ...
    async def create(
        ...
        bid = await Bid.prisma().create(
            data={
                ...
                'contractId': 'geihgahba',
                'teamSeasonId': 'gahdcdhbj',
                'amount': 1468890740,
            },
        )
        ```
        ...
        *,
        ...
        total = await Bid.prisma().create_many(
            data=[
                {
                    # data to create a Bid record
                    'contractId': 'gcjadjaaf',
                    'teamSeasonId': 'bcbebgiaic',
                    'amount': 898613219,
                },
                {
                    # data to create a Bid record
                    'contractId': 'gfidhicai',
                    'teamSeasonId': 'jfegcaafh',
                    'amount': 1214809950,
                },
            ],
            skip_duplicates=True,
    ...
    async def create(
        ...
        match = await Match.prisma().create(
            data={
                ...
                'teamSeasonId': 'cefjaadec',
                'eaMatchId': 'ibbigdigd',
                'goalsAgainst': 1388801188,
                'goalsFor': 752577037,
                'opponentClubId': 'bbihggdcji',
                'opponentTeamId': 'hgjgibdgd',
                'penaltyKillGoalsAgainst': 1214295824,
                'penaltyKillOpportunities': 1021417993,
                'powerplayGoals': 351503374,
                'powerplayOpportunities': 1321184815,
                'shots': 369732668,
                'shotsAgainst': 1191235013,
                'timeOnAttack': 627561242,
            },
        )
        ```
        """
        ...
        *,
        ...
        total = await Match.prisma().create_many(
            data=[
                {
                    # data to create a Match record
                    'teamSeasonId': 'bihcjfcjah',
                    'eaMatchId': 'bhjdcicaii',
                    'goalsAgainst': 1814397249,
                    'goalsFor': 1923090150,
                    'opponentClubId': 'bchhceeeff',
                    'opponentTeamId': 'bbgaifhdaa',
                    'penaltyKillGoalsAgainst': 361230461,
                    'penaltyKillOpportunities': 1406511986,
                    'powerplayGoals': 1482877891,
                    'powerplayOpportunities': 566623296,
                    'shots': 229119865,
                    'shotsAgainst': 1750011070,
                    'timeOnAttack': 410943775,
                },
                {
                    # data to create a Match record
                    'teamSeasonId': 'jajacedge',
                    'eaMatchId': 'hffgbabgf',
                    'goalsAgainst': 1802188490,
                    'goalsFor': 294916155,
                    'opponentClubId': 'fgeahddae',
                    'opponentTeamId': 'diageigcf',
                    'penaltyKillGoalsAgainst': 1030616470,
                    'penaltyKillOpportunities': 816411927,
                    'powerplayGoals': 1084099844,
                    'powerplayOpportunities': 1079702253,
                    'shots': 755750178,
                    'shotsAgainst': 1128680371,
                    'timeOnAttack': 259061104,
                },
            ],
            skip_duplicates=True,
        )
    ...
    async def create(
        ...
        playermatch = await PlayerMatch.prisma().create(
            data={
                ...
                'matchId': 'beeacgfcej',
                'playerTeamSeasonId': 'bbifhdiicc',
                'assists': 1694224903,
                'giveaways': 1906360116,
                'goals': 1911255389,
                'hits': 146262738,
                'penaltyMinutes': 1719240611,
                'plusMinus': 1948555936,
                'ratingDefense': 1383253593.35466,
                'ratingOffense': 647166719.35708,
                'ratingTeamplay': 612396821.180813,
                'shots': 1151748123,
                'takeaways': 78060984,
                'timeOnIce': 444983185,
            },
            ...
            data=[
                {
                    # data to create a PlayerMatch record
                    'matchId': 'efgbahec',
                    'playerTeamSeasonId': 'hgjaiebfb',
                    'assists': 1334599012,
                    'giveaways': 1116761037,
                    'goals': 1172606082,
                    'hits': 330014611,
                    'penaltyMinutes': 1768156112,
                    'plusMinus': 71628745,
                    'ratingDefense': 55766734.81203,
                    'ratingOffense': 1323562236.4379,
                    'ratingTeamplay': 1345530330.196538,
                    'shots': 804873448,
                    'takeaways': 1566496513,
                    'timeOnIce': 850004390,
                },
                {
                    # data to create a PlayerMatch record
                    'matchId': 'cbajdjjabf',
                    'playerTeamSeasonId': 'bcicggedea',
                    'assists': 241230397,
                    'giveaways': 475863602,
                    'goals': 1716228995,
                    'hits': 1869736192,
                    'penaltyMinutes': 1585341753,
                    'plusMinus': 29271934,
                    'ratingDefense': 1588192479.89840,
                    'ratingOffense': 777460725.43789,
                    'ratingTeamplay': 393342971.16382,
                    'shots': 248152689,
                    'takeaways': 341715030,
                    'timeOnIce': 1692766423,
                },
            ],
            skip_duplicates=True,
        )
