...
class BaseLeague(_PrismaModel):
    __prisma_model__: ClassVar[Literal['League']] = 'League'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.LeagueActions[_PrismaModelT]':
        from .client import get_client

        return actions.LeagueActions[_PrismaModelT](client or get_client(), cls)


class BaseLeagueSeason(_PrismaModel):
    __prisma_model__: ClassVar[Literal['LeagueSeason']] = 'LeagueSeason'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.LeagueSeasonActions[_PrismaModelT]':
        from .client import get_client

        return actions.LeagueSeasonActions[_PrismaModelT](client or get_client(), cls)


class BaseConference(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Conference']] = 'Conference'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.ConferenceActions[_PrismaModelT]':
        from .client import get_client

        return actions.ConferenceActions[_PrismaModelT](client or get_client(), cls)


class BaseDivision(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Division']] = 'Division'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.DivisionActions[_PrismaModelT]':
        from .client import get_client

        return actions.DivisionActions[_PrismaModelT](client or get_client(), cls)
...
class BaseLeagueCommissioner(_PrismaModel):
    __prisma_model__: ClassVar[Literal['LeagueCommissioner']] = 'LeagueCommissioner'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.LeagueCommissionerActions[_PrismaModelT]':
        from .client import get_client

        return actions.LeagueCommissionerActions[_PrismaModelT](client or get_client(), cls)


class BaseLeagueBOG(_PrismaModel):
    __prisma_model__: ClassVar[Literal['LeagueBOG']] = 'LeagueBOG'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.LeagueBOGActions[_PrismaModelT]':
        from .client import get_client

        return actions.LeagueBOGActions[_PrismaModelT](client or get_client(), cls)
...
class BaseClubMatchStats(_PrismaModel):
    __prisma_model__: ClassVar[Literal['ClubMatchStats']] = 'ClubMatchStats'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.ClubMatchStatsActions[_PrismaModelT]':
        from .client import get_client

        return actions.ClubMatchStatsActions[_PrismaModelT](client or get_client(), cls)


class BaseClubMatchStatsDetails(_PrismaModel):
    __prisma_model__: ClassVar[Literal['ClubMatchStatsDetails']] = 'ClubMatchStatsDetails'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.ClubMatchStatsDetailsActions[_PrismaModelT]':
        from .client import get_client

        return actions.ClubMatchStatsDetailsActions[_PrismaModelT](client or get_client(), cls)


class BaseCustomKit(_PrismaModel):
    __prisma_model__: ClassVar[Literal['CustomKit']] = 'CustomKit'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.CustomKitActions[_PrismaModelT]':
        from .client import get_client

        return actions.CustomKitActions[_PrismaModelT](client or get_client(), cls)


class BaseClubAggregateMatchStats(_PrismaModel):
    __prisma_model__: ClassVar[Literal['ClubAggregateMatchStats']] = 'ClubAggregateMatchStats'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.ClubAggregateMatchStatsActions[_PrismaModelT]':
        from .client import get_client

        return actions.ClubAggregateMatchStatsActions[_PrismaModelT](client or get_client(), cls)


class BaseMatchAnalytics(_PrismaModel):
    __prisma_model__: ClassVar[Literal['MatchAnalytics']] = 'MatchAnalytics'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.MatchAnalyticsActions[_PrismaModelT]':
        from .client import get_client

        return actions.MatchAnalyticsActions[_PrismaModelT](client or get_client(), cls)
...
class BasePlayerLeagueHistory(_PrismaModel):
    __prisma_model__: ClassVar[Literal['PlayerLeagueHistory']] = 'PlayerLeagueHistory'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.PlayerLeagueHistoryActions[_PrismaModelT]':
        from .client import get_client

        return actions.PlayerLeagueHistoryActions[_PrismaModelT](client or get_client(), cls)
...
class BaseEaIdHistory(_PrismaModel):
    __prisma_model__: ClassVar[Literal['EaIdHistory']] = 'EaIdHistory'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.EaIdHistoryActions[_PrismaModelT]':
        from .client import get_client

        return actions.EaIdHistoryActions[_PrismaModelT](client or get_client(), cls)


class BaseSystemHistory(_PrismaModel):
    __prisma_model__: ClassVar[Literal['SystemHistory']] = 'SystemHistory'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.SystemHistoryActions[_PrismaModelT]':
        from .client import get_client

        return actions.SystemHistoryActions[_PrismaModelT](client or get_client(), cls)
