  ...
  const handleSubmitBid = () => {
    ...
    if (teamData) {
      ...
      if (adjustedProposedTotal > salaryCap) {
        setError(
          `This bid would exceed your salary cap of $${salaryCap.toLocaleString()}`
        );
        return;
      }
      ...
      const minRosterCost = MIN_FORWARDS * MIN_SALARY + MIN_DEFENSE * MIN_SALARY + MIN_GOALIES * MIN_SALARY;
        ...
        <DialogContent className="sm:max-w-[425px] bg-gray-900 border-gray-800">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span>${currentBid === null 
                ? (startingAmount ? startingAmount.toLocaleString() : DEFAULT_STARTING_AMOUNT.toLocaleString()) 
                : currentBid.toLocaleString()}</span>
            </div>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={
                ...
                (currentBid === null
                  ? bidAmount < (startingAmount || DEFAULT_STARTING_AMOUNT) || bidAmount % BID_INCREMENT !== 0
                  : bidAmount < currentBid + BID_INCREMENT || bidAmount % BID_INCREMENT !== 0) || localIsSubmitting
              }
