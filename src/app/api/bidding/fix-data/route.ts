      ...
      if (data) {
        ...
        if (player.tierId === tier.id) {
          ...
          if (playerData) {
            ...
            const hasActiveBid = player.currentBid !== null && player.currentBid !== player.contract.amount && player.currentTeamId !== null;
      ...
      if (data) {
        ...
        if (player.tierId === tier.id) {
          ...
          playerData.push({
            ...
            hasActiveBid: player.currentBid !== player.contract.amount && player.currentTeamId !== null
          });
        }
      }
    }
